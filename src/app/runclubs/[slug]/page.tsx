    ...
    <div className={`${styles.page} page-single-runclub`}>
      ...
      <header className={`${styles.pageHeader} container fp`}>
       ...
       {club.logo ? (
          ...
          <div className={styles.pageHeader__image}>
             <Image
              unoptimized
        ...
        <ul className={`${styles.pageHeader__socials} list-flex`}>
          ...
          <li className='btn_main socials white'>
            ...
            <a href="#" className="txt-body" aria-label="Visit our Facebook page">Facebook</a>
          </li>
          )}
          {hasWebsite && (
          <li className='btn_main socials white'>
            ...
            <a href="#" className="txt-body" aria-label="Visit our website">Website</a>
          </li>
          )}
          {hasInstagram && (
          <li className='btn_main socials white'>
            ...
            <a href="#" className="txt-body" aria-label="Visit our Instagram page">Instagram</a>
          </li>
          )}
          {hasStrava && (
          <li className='btn_main socials white'>
            ...
            <a href="#" className="txt-body" aria-label="Visit our Strava profile">Strava</a>
          </li>
          )}
        </ul>
      </header>
